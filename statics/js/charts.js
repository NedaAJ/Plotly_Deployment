...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var samplesArray = samples.filter(sampleObj => sampleObj.id == sample);
      //4.1 . Create a variable that filters the metadata array for the object with the desired sample number.
    ...
    // 6.1 . Create a variable that holds the washing frequency.
